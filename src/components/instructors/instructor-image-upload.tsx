...
type Props = {
  /** Current photo URL (edit mode). When no new file is selected, this is used. */
  currentPhotoUrl?: string | null;
};

export function InstructorImageUpload({ currentPhotoUrl }: Props) {
  ...
  return (
    <div className="grid gap-2">
      ...
      {/* When no new file: pass current URL or empty to server */}
      {!previewUrl && (
        <input
          type="hidden"
          name="photoUrl"
